...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private global::AttackRootMotionController _attackRootMotionController;
        ...
        private void Start()
        {
            ...
            _attackRootMotionController = GetComponent<global::AttackRootMotionController>();
            if (_attackRootMotionController == null)
            {
                _attackRootMotionController = GetComponentInChildren<global::AttackRootMotionController>();
            }
#if ENABLE_INPUT_SYSTEM 
        ...
        private void OnAnimatorMove()
        {
            ...
            if (_playerAttack != null &&
                ...
                _attackRootMotionController != null &&
                _attackRootMotionController.IsHandlingAttackRootMotion)
            {
                return;
            }
